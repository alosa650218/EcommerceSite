...
$config['core:_label'] = HCM::__('Configuration');
$config['core:measure'] = array(
...
$config['front_map:_label'] = HCM::__('Details On Map');
...
$config['front_list:_label'] = HCM::__('Details In List');
