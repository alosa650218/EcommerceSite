...
class Api_Api_HC_MVC extends _HC_MVC
{
...
// VIEW
	public function get( $args = array() )
	{
		...
		if( isset($args['custom']) ){
			...
			$method = 'custom-get-' . $what;
			$custom = $this->make( $this->slug() )
				->set_model( $this->model() )
				;
			return $custom->run($method, $args);
		}
		...
		if( isset($args['which']) ){
			...
			$return = $custom->run($method, $what, $args);
...
// DELETE
	...
	public function which( $what, $args = array() )
	{
		$return = array();
		return $return;
	}

	public function what( $args = array() )
	{
		$return = array();
		return $return;
	}
